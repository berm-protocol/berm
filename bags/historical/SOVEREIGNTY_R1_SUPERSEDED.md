<!-- STATUS: HISTORICAL_SPEC / SUPERSEDED_BY_SOVEREIGNTY_R4 -->

> # ⚠ HISTORICAL — EVIDENCE ONLY, NOT CURRENT AUTHORITY
>
> `HISTORICAL_SPEC / SUPERSEDED_BY_SOVEREIGNTY_R4`
>
> Superseded by the canonical `../SOVEREIGNTY.md`. It is framed around manual developer funding, a single root at deployment, and permissionless stranger-executed claims — a predecessor architecture, not the current lifecycle.
>
