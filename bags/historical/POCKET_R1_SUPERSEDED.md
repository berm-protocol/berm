<!-- STATUS: HISTORICAL_SPEC / SUPERSEDED_BY_POCKET_R4 -->

> # ⚠ HISTORICAL — EVIDENCE ONLY, NOT CURRENT AUTHORITY
>
> `HISTORICAL_SPEC / SUPERSEDED_BY_POCKET_R4`
>
> Superseded by the canonical `../POCKET.md`. It teaches a derived pocket for every user, an addressless enrollment, and push-not-pull payout — all three are the rejected model.
>
